...
const String PLAYER1_SYMBOL = 'Playstation';
const Color PLAYER1_COLOR = Colors.red; // Alfa RGB (0xFFFF0000)
const String PLAYER1_IMG = 'assets/playstation.png';

const String PLAYER2_SYMBOL = 'Xbox';
const Color PLAYER2_COLOR = Colors.blue;
const String PLAYER2_IMG = 'assets/xbox.png';
